...
Elm.AddForm = Elm.AddForm || {};
Elm.AddForm.make = function (_elm) {
   "use strict";
   _elm.AddForm = _elm.AddForm || {};
   if (_elm.AddForm.values) return _elm.AddForm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Css = Elm.Css.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "ChangeInitialData") {
            ...
            return A3($EffectsUtil.update,
            function (x) {
               return _U.update(model,{tagSelector: x});
            },
            TagSelectorAction,
   ...
   return _elm.AddForm.values = {_op: _op
                                ,Model: Model
