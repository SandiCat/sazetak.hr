...
Elm.Material.Icons.Internal.make = function (_elm) {
   ...
   if (_elm.Material.Icons.Internal.values) return _elm.Material.Icons.Internal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var toRgbaString = function (color) {
      ...
      A2($Basics._op["++"],",",A2($Basics._op["++"],$Basics.toString(blue),A2($Basics._op["++"],",",A2($Basics._op["++"],$Basics.toString(alpha),")"))))))));
   };
   var icon = F3(function (path,color,size) {
      var stringColor = toRgbaString(color);
      var stringSize = $Basics.toString(size);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 24 24")]),
      _U.list([A2($Svg.path,_U.list([$Svg$Attributes.d(path),$Svg$Attributes.fill(stringColor)]),_U.list([]))]));
   });
   return _elm.Material.Icons.Internal.values = {_op: _op,icon: icon,toRgbaString: toRgbaString};
};
Elm.Material = Elm.Material || {};
Elm.Material.Icons = Elm.Material.Icons || {};
Elm.Material.Icons.Action = Elm.Material.Icons.Action || {};
Elm.Material.Icons.Action.make = function (_elm) {
   "use strict";
   _elm.Material = _elm.Material || {};
   _elm.Material.Icons = _elm.Material.Icons || {};
   _elm.Material.Icons.Action = _elm.Material.Icons.Action || {};
   if (_elm.Material.Icons.Action.values) return _elm.Material.Icons.Action.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $VirtualDom = Elm.VirtualDom.make(_elm);
   var _op = {};
   var zoom_out = $Material$Icons$Internal.icon("M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zM7 9h5v1H7z");
   var zoom_in = $Material$Icons$Internal.icon("M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zM12 10h-2v2H9v-2H7V9h2V7h1v2h2v1z");
   var youtube_searched_for = $Material$Icons$Internal.icon("M17.01 14h-.8l-.27-.27c.98-1.14 1.57-2.61 1.57-4.23 0-3.59-2.91-6.5-6.5-6.5s-6.5 3-6.5 6.5H2l3.84 4 4.16-4H6.51C6.51 7 8.53 5 11.01 5s4.5 2.01 4.5 4.5c0 2.48-2.02 4.5-4.5 4.5-.65 0-1.26-.14-1.82-.38L7.71 15.1c.97.57 2.09.9 3.3.9 1.61 0 3.08-.59 4.22-1.57l.27.27v.79l5.01 4.99L22 19l-4.99-5z");
   var work = $Material$Icons$Internal.icon("M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z");
   var visibility_off = $Material$Icons$Internal.icon("M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.26 2.7-2.89 3.43-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46C3.08 8.3 1.78 10.02 1 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm4.31-.78l3.15 3.15.02-.16c0-1.66-1.34-3-3-3l-.17.01z");
   var visibility = $Material$Icons$Internal.icon("M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z");
   var view_week = $Material$Icons$Internal.icon("M6 5H3c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h3c.55 0 1-.45 1-1V6c0-.55-.45-1-1-1zm14 0h-3c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h3c.55 0 1-.45 1-1V6c0-.55-.45-1-1-1zm-7 0h-3c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h3c.55 0 1-.45 1-1V6c0-.55-.45-1-1-1z");
   var view_stream = $Material$Icons$Internal.icon("M4 18h17v-6H4v6zM4 5v6h17V5H4z");
   var view_quilt = $Material$Icons$Internal.icon("M10 18h5v-6h-5v6zm-6 0h5V5H4v13zm12 0h5v-6h-5v6zM10 5v6h11V5H10z");
   var view_module = $Material$Icons$Internal.icon("M4 11h5V5H4v6zm0 7h5v-6H4v6zm6 0h5v-6h-5v6zm6 0h5v-6h-5v6zm-6-7h5V5h-5v6zm6-6v6h5V5h-5z");
   var view_list = $Material$Icons$Internal.icon("M4 14h4v-4H4v4zm0 5h4v-4H4v4zM4 9h4V5H4v4zm5 5h12v-4H9v4zm0 5h12v-4H9v4zM9 5v4h12V5H9z");
   var view_headline = $Material$Icons$Internal.icon("M4 15h16v-2H4v2zm0 4h16v-2H4v2zm0-8h16V9H4v2zm0-6v2h16V5H4z");
   var view_day = $Material$Icons$Internal.icon("M2 21h19v-3H2v3zM20 8H3c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h17c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1zM2 3v3h19V3H2z");
   var view_column = $Material$Icons$Internal.icon("M10 18h5V5h-5v13zm-6 0h5V5H4v13zM16 5v13h5V5h-5z");
   var view_carousel = $Material$Icons$Internal.icon("M7 19h10V4H7v15zm-5-2h4V6H2v11zM18 6v11h4V6h-4z");
   var view_array = $Material$Icons$Internal.icon("M4 18h3V5H4v13zM18 5v13h3V5h-3zM8 18h9V5H8v13z");
   var view_agenda = $Material$Icons$Internal.icon("M20 13H3c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h17c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zm0-10H3c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h17c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1z");
   var verified_user = $Material$Icons$Internal.icon("M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z");
   var turned_in_not = $Material$Icons$Internal.icon("M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2zm0 15l-5-2.18L7 18V5h10v13z");
   var turned_in = $Material$Icons$Internal.icon("M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2z");
   var trending_up = $Material$Icons$Internal.icon("M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z");
   var trending_flat = $Material$Icons$Internal.icon("M22 12l-4-4v3H3v2h15v3z");
   var trending_down = $Material$Icons$Internal.icon("M16 18l2.29-2.29-4.88-4.88-4 4L2 7.41 3.41 6l6 6 4-4 6.3 6.29L22 12v6z");
   var translate = $Material$Icons$Internal.icon("M12.87 15.07l-2.54-2.51.03-.03c1.74-1.94 2.98-4.17 3.71-6.53H17V4h-7V2H8v2H1v1.99h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z");
   ...
   var toll = $Material$Icons$Internal.icon("M15 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zM3 12c0-2.61 1.67-4.83 4-5.65V4.26C3.55 5.15 1 8.27 1 12s2.55 6.85 6 7.74v-2.09c-2.33-.82-4-3.04-4-5.65z");
   var today = $Material$Icons$Internal.icon("M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zM7 10h5v5H7z");
   var toc = $Material$Icons$Internal.icon("M3 9h14V7H3v2zm0 4h14v-2H3v2zm0 4h14v-2H3v2zm16 0h2v-2h-2v2zm0-10v2h2V7h-2zm0 6h2v-2h-2v2z");
   var thumps_up_down = $Material$Icons$Internal.icon("M12 6c0-.55-.45-1-1-1H5.82l.66-3.18.02-.23c0-.31-.13-.59-.33-.8L5.38 0 .44 4.94C.17 5.21 0 5.59 0 6v6.5c0 .83.67 1.5 1.5 1.5h6.75c.62 0 1.15-.38 1.38-.91l2.26-5.29c.07-.17.11-.36.11-.55V6zm10.5 4h-6.75c-.62 0-1.15.38-1.38.91l-2.26 5.29c-.07.17-.11.36-.11.55V18c0 .55.45 1 1 1h5.18l-.66 3.18-.02.24c0 .31.13.59.33.8l.79.78 4.94-4.94c.27-.27.44-.65.44-1.06v-6.5c0-.83-.67-1.5-1.5-1.5z");
   var thumb_up = $Material$Icons$Internal.icon("M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-1.91l-.01-.01L23 10z");
   var thumb_down = $Material$Icons$Internal.icon("M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v1.91l.01.01L1 14c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z");
   var theaters = $Material$Icons$Internal.icon("M18 3v2h-2V3H8v2H6V3H4v18h2v-2h2v2h8v-2h2v2h2V3h-2zM8 17H6v-2h2v2zm0-4H6v-2h2v2zm0-4H6V7h2v2zm10 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2z");
   var tab_unselected = $Material$Icons$Internal.icon("M1 9h2V7H1v2zm0 4h2v-2H1v2zm0-8h2V3c-1.1 0-2 .9-2 2zm8 16h2v-2H9v2zm-8-4h2v-2H1v2zm2 4v-2H1c0 1.1.9 2 2 2zM21 3h-8v6h10V5c0-1.1-.9-2-2-2zm0 14h2v-2h-2v2zM9 5h2V3H9v2zM5 21h2v-2H5v2zM5 5h2V3H5v2zm16 16c1.1 0 2-.9 2-2h-2v2zm0-8h2v-2h-2v2zm-8 8h2v-2h-2v2zm4 0h2v-2h-2v2z");
   var tab = $Material$Icons$Internal.icon("M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h10v4h8v10z");
   var system_update_alt = $Material$Icons$Internal.icon("M12 16.5l4-4h-3v-9h-2v9H8l4 4zm9-13h-6v1.99h6v14.03H3V5.49h6V3.5H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2v-14c0-1.1-.9-2-2-2z");
   var swap_vertical_circle = $Material$Icons$Internal.icon("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM6.5 9L10 5.5 13.5 9H11v4H9V9H6.5zm11 6L14 18.5 10.5 15H13v-4h2v4h2.5z");
   var swap_vert = $Material$Icons$Internal.icon("M16 17.01V10h-2v7.01h-3L15 21l4-3.99h-3zM9 3L5 6.99h3V14h2V6.99h3L9 3z");
   var swap_horiz = $Material$Icons$Internal.icon("M6.99 11L3 15l3.99 4v-3H14v-2H6.99v-3zM21 9l-3.99-4v3H10v2h7.01v3L21 9z");
   var supervisor_account = $Material$Icons$Internal.icon("M16.5 12c1.38 0 2.49-1.12 2.49-2.5S17.88 7 16.5 7C15.12 7 14 8.12 14 9.5s1.12 2.5 2.5 2.5zM9 11c1.66 0 2.99-1.34 2.99-3S10.66 5 9 5C7.34 5 6 6.34 6 8s1.34 3 3 3zm7.5 3c-1.83 0-5.5.92-5.5 2.75V19h11v-2.25c0-1.83-3.67-2.75-5.5-2.75zM9 13c-2.33 0-7 1.17-7 3.5V19h7v-2.25c0-.85.33-2.34 2.37-3.47C10.5 13.1 9.66 13 9 13z");
   var subject = $Material$Icons$Internal.icon("M14 17H4v2h10v-2zm6-8H4v2h16V9zM4 15h16v-2H4v2zM4 5v2h16V5H4z");
   var store = $Material$Icons$Internal.icon("M20 4H4v2h16V4zm1 10v-2l-1-5H4l-1 5v2h1v6h10v-6h4v6h2v-6h1zm-9 4H6v-4h6v4z");
   var stars = $Material$Icons$Internal.icon("M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm4.24 16L12 15.45 7.77 18l1.12-4.81-3.73-3.23 4.92-.42L12 5l1.92 4.53 4.92.42-3.73 3.23L16.23 18z");
   var star_rate = F2(function (color,size) {
      var stringSize = $Basics.toString(size);
      var stringColor = $Material$Icons$Internal.toRgbaString(color);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 18 18")]),
      _U.list([A2($Svg.path,
      _U.list([$Svg$Attributes.d("M9 11.3l3.71 2.7-1.42-4.36L15 7h-4.55L9 2.5 7.55 7H3l3.71 2.64L5.29 14z"),$Svg$Attributes.fill(stringColor)]),
      _U.list([]))]));
   });
   var spellcheck = $Material$Icons$Internal.icon("M12.45 16h2.09L9.43 3H7.57L2.46 16h2.09l1.12-3h5.64l1.14 3zm-6.02-5L8.5 5.48 10.57 11H6.43zm15.16.59l-8.09 8.09L9.83 16l-1.41 1.41 5.09 5.09L23 13l-1.41-1.41z");
   var speaker_notes = $Material$Icons$Internal.icon("M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM8 14H6v-2h2v2zm0-3H6V9h2v2zm0-3H6V6h2v2zm7 6h-5v-2h5v2zm3-3h-8V9h8v2zm0-3h-8V6h8v2z");
   var shopping_cart = $Material$Icons$Internal.icon("M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z");
   var shopping_basket = $Material$Icons$Internal.icon("M17.21 9l-4.38-6.56c-.19-.28-.51-.42-.83-.42-.32 0-.64.14-.83.43L6.79 9H2c-.55 0-1 .45-1 1 0 .09.01.18.04.27l2.54 9.27c.23.84 1 1.46 1.92 1.46h13c.92 0 1.69-.62 1.93-1.46l2.54-9.27L23 10c0-.55-.45-1-1-1h-4.79zM9 9l3-4.4L15 9H9zm3 8c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z");
   var shop_two = $Material$Icons$Internal.icon("M3 9H1v11c0 1.11.89 2 2 2h14c1.11 0 2-.89 2-2H3V9zm15-4V3c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H5v11c0 1.11.89 2 2 2h14c1.11 0 2-.89 2-2V5h-5zm-6-2h4v2h-4V3zm0 12V8l5.5 3-5.5 4z");
   var shop = $Material$Icons$Internal.icon("M16 6V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H2v13c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6h-6zm-6-2h4v2h-4V4zM9 18V9l7.5 4L9 18z");
   var settings_voice = $Material$Icons$Internal.icon("M7 24h2v-2H7v2zm5-11c1.66 0 2.99-1.34 2.99-3L15 4c0-1.66-1.34-3-3-3S9 2.34 9 4v6c0 1.66 1.34 3 3 3zm-1 11h2v-2h-2v2zm4 0h2v-2h-2v2zm4-14h-1.7c0 3-2.54 5.1-5.3 5.1S6.7 13 6.7 10H5c0 3.41 2.72 6.23 6 6.72V20h2v-3.28c3.28-.49 6-3.31 6-6.72z");
   var settings_remote = $Material$Icons$Internal.icon("M15 9H9c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h6c.55 0 1-.45 1-1V10c0-.55-.45-1-1-1zm-3 6c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM7.05 6.05l1.41 1.41C9.37 6.56 10.62 6 12 6s2.63.56 3.54 1.46l1.41-1.41C15.68 4.78 13.93 4 12 4s-3.68.78-4.95 2.05zM12 0C8.96 0 6.21 1.23 4.22 3.22l1.41 1.41C7.26 3.01 9.51 2 12 2s4.74 1.01 6.36 2.64l1.41-1.41C17.79 1.23 15.04 0 12 0z");
   var settings_power = $Material$Icons$Internal.icon("M7 24h2v-2H7v2zm4 0h2v-2h-2v2zm2-22h-2v10h2V2zm3.56 2.44l-1.45 1.45C16.84 6.94 18 8.83 18 11c0 3.31-2.69 6-6 6s-6-2.69-6-6c0-2.17 1.16-4.06 2.88-5.12L7.44 4.44C5.36 5.88 4 8.28 4 11c0 4.42 3.58 8 8 8s8-3.58 8-8c0-2.72-1.36-5.12-3.44-6.56zM15 24h2v-2h-2v2z");
   var settings_phone = $Material$Icons$Internal.icon("M13 9h-2v2h2V9zm4 0h-2v2h2V9zm3 6.5c-1.25 0-2.45-.2-3.57-.57-.35-.11-.74-.03-1.02.24l-2.2 2.2c-2.83-1.44-5.15-3.75-6.59-6.58l2.2-2.21c.28-.27.36-.66.25-1.01C8.7 6.45 8.5 5.25 8.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1zM19 9v2h2V9h-2z");
   var settings_overscan = $Material$Icons$Internal.icon("M12.01 5.5L10 8h4l-1.99-2.5zM18 10v4l2.5-1.99L18 10zM6 10l-2.5 2.01L6 14v-4zm8 6h-4l2.01 2.5L14 16zm7-13H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16.01H3V4.99h18v14.02z");
   var settings_input_svideo = $Material$Icons$Internal.icon("M8 11.5c0-.83-.67-1.5-1.5-1.5S5 10.67 5 11.5 5.67 13 6.5 13 8 12.33 8 11.5zm7-5c0-.83-.67-1.5-1.5-1.5h-3C9.67 5 9 5.67 9 6.5S9.67 8 10.5 8h3c.83 0 1.5-.67 1.5-1.5zM8.5 15c-.83 0-1.5.67-1.5 1.5S7.67 18 8.5 18s1.5-.67 1.5-1.5S9.33 15 8.5 15zM12 1C5.93 1 1 5.93 1 12s4.93 11 11 11 11-4.93 11-11S18.07 1 12 1zm0 20c-4.96 0-9-4.04-9-9s4.04-9 9-9 9 4.04 9 9-4.04 9-9 9zm5.5-11c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5zm-2 5c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5z");
   var settings_input_hdmi = $Material$Icons$Internal.icon("M18 7V4c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v3H5v6l3 6v3h8v-3l3-6V7h-1zM8 4h8v3h-2V5h-1v2h-2V5h-1v2H8V4z");
   var settings_input_composite = $Material$Icons$Internal.icon("M5 2c0-.55-.45-1-1-1s-1 .45-1 1v4H1v6h6V6H5V2zm4 14c0 1.3.84 2.4 2 2.82V23h2v-4.18c1.16-.41 2-1.51 2-2.82v-2H9v2zm-8 0c0 1.3.84 2.4 2 2.82V23h2v-4.18C6.16 18.4 7 17.3 7 16v-2H1v2zM21 6V2c0-.55-.45-1-1-1s-1 .45-1 1v4h-2v6h6V6h-2zm-8-4c0-.55-.45-1-1-1s-1 .45-1 1v4H9v6h6V6h-2V2zm4 14c0 1.3.84 2.4 2 2.82V23h2v-4.18c1.16-.41 2-1.51 2-2.82v-2h-6v2z");
   var settings_input_component = $Material$Icons$Internal.icon("M5 2c0-.55-.45-1-1-1s-1 .45-1 1v4H1v6h6V6H5V2zm4 14c0 1.3.84 2.4 2 2.82V23h2v-4.18c1.16-.41 2-1.51 2-2.82v-2H9v2zm-8 0c0 1.3.84 2.4 2 2.82V23h2v-4.18C6.16 18.4 7 17.3 7 16v-2H1v2zM21 6V2c0-.55-.45-1-1-1s-1 .45-1 1v4h-2v6h6V6h-2zm-8-4c0-.55-.45-1-1-1s-1 .45-1 1v4H9v6h6V6h-2V2zm4 14c0 1.3.84 2.4 2 2.82V23h2v-4.18c1.16-.41 2-1.51 2-2.82v-2h-6v2z");
   var settings_input_antenna = $Material$Icons$Internal.icon("M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm1 9.29c.88-.39 1.5-1.26 1.5-2.29 0-1.38-1.12-2.5-2.5-2.5S9.5 10.62 9.5 12c0 1.02.62 1.9 1.5 2.29v3.3L7.59 21 9 22.41l3-3 3 3L16.41 21 13 17.59v-3.3zM12 1C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11z");
   var settings_ethernet = $Material$Icons$Internal.icon("M7.77 6.76L6.23 5.48.82 12l5.41 6.52 1.54-1.28L3.42 12l4.35-5.24zM7 13h2v-2H7v2zm10-2h-2v2h2v-2zm-6 2h2v-2h-2v2zm6.77-7.52l-1.54 1.28L20.58 12l-4.35 5.24 1.54 1.28L23.18 12l-5.41-6.52z");
   var settings_cell = $Material$Icons$Internal.icon("M7 24h2v-2H7v2zm4 0h2v-2h-2v2zm4 0h2v-2h-2v2zM16 .01L8 0C6.9 0 6 .9 6 2v16c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V2c0-1.1-.9-1.99-2-1.99zM16 16H8V4h8v12z");
   var settings_brightness = $Material$Icons$Internal.icon("M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16.01H3V4.99h18v14.02zM8 16h2.5l1.5 1.5 1.5-1.5H16v-2.5l1.5-1.5-1.5-1.5V8h-2.5L12 6.5 10.5 8H8v2.5L6.5 12 8 13.5V16zm4-7c1.66 0 3 1.34 3 3s-1.34 3-3 3V9z");
   var settings_bluetooth = $Material$Icons$Internal.icon("M11 24h2v-2h-2v2zm-4 0h2v-2H7v2zm8 0h2v-2h-2v2zm2.71-18.29L12 0h-1v7.59L6.41 3 5 4.41 10.59 10 5 15.59 6.41 17 11 12.41V20h1l5.71-5.71-4.3-4.29 4.3-4.29zM13 3.83l1.88 1.88L13 7.59V3.83zm1.88 10.46L13 16.17v-3.76l1.88 1.88z");
   var settings_backup_restore = $Material$Icons$Internal.icon("M14 12c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2 2-.9 2-2zm-2-9c-4.97 0-9 4.03-9 9H0l4 4 4-4H5c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.51 0-2.91-.49-4.06-1.3l-1.42 1.44C8.04 20.3 9.94 21 12 21c4.97 0 9-4.03 9-9s-4.03-9-9-9z");
   var settings_application = $Material$Icons$Internal.icon("M12 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm7-7H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-1.75 9c0 .23-.02.46-.05.68l1.48 1.16c.13.11.17.3.08.45l-1.4 2.42c-.09.15-.27.21-.43.15l-1.74-.7c-.36.28-.76.51-1.18.69l-.26 1.85c-.03.17-.18.3-.35.3h-2.8c-.17 0-.32-.13-.35-.29l-.26-1.85c-.43-.18-.82-.41-1.18-.69l-1.74.7c-.16.06-.34 0-.43-.15l-1.4-2.42c-.09-.15-.05-.34.08-.45l1.48-1.16c-.03-.23-.05-.46-.05-.69 0-.23.02-.46.05-.68l-1.48-1.16c-.13-.11-.17-.3-.08-.45l1.4-2.42c.09-.15.27-.21.43-.15l1.74.7c.36-.28.76-.51 1.18-.69l.26-1.85c.03-.17.18-.3.35-.3h2.8c.17 0 .32.13.35.29l.26 1.85c.43.18.82.41 1.18.69l1.74-.7c.16-.06.34 0 .43.15l1.4 2.42c.09.15.05.34-.08.45l-1.48 1.16c.03.23.05.46.05.69z");
   var settings = $Material$Icons$Internal.icon("M19.43 12.98c.04-.32.07-.64.07-.98s-.03-.66-.07-.98l2.11-1.65c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.39-.3-.61-.22l-2.49 1c-.52-.4-1.08-.73-1.69-.98l-.38-2.65C14.46 2.18 14.25 2 14 2h-4c-.25 0-.46.18-.49.42l-.38 2.65c-.61.25-1.17.59-1.69.98l-2.49-1c-.23-.09-.49 0-.61.22l-2 3.46c-.13.22-.07.49.12.64l2.11 1.65c-.04.32-.07.65-.07.98s.03.66.07.98l-2.11 1.65c-.19.15-.24.42-.12.64l2 3.46c.12.22.39.3.61.22l2.49-1c.52.4 1.08.73 1.69.98l.38 2.65c.03.24.24.42.49.42h4c.25 0 .46-.18.49-.42l.38-2.65c.61-.25 1.17-.59 1.69-.98l2.49 1c.23.09.49 0 .61-.22l2-3.46c.12-.22.07-.49-.12-.64l-2.11-1.65zM12 15.5c-1.93 0-3.5-1.57-3.5-3.5s1.57-3.5 3.5-3.5 3.5 1.57 3.5 3.5-1.57 3.5-3.5 3.5z");
   var search = $Material$Icons$Internal.icon("M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z");
   var schedule = F2(function (color,size) {
      var stringSize = $Basics.toString(size);
      var stringColor = $Material$Icons$Internal.toRgbaString(color);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 24 24")]),
      _U.list([A2($Svg.path,
      _U.list([$Svg$Attributes.fillOpacity(".9")
   ...
   var room = $Material$Icons$Internal.icon("M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z");
   var restore = $Material$Icons$Internal.icon("M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z");
   var report_problem = $Material$Icons$Internal.icon("M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z");
   var reorder = $Material$Icons$Internal.icon("M3 15h18v-2H3v2zm0 4h18v-2H3v2zm0-8h18V9H3v2zm0-6v2h18V5H3z");
   var redeem = $Material$Icons$Internal.icon("M20 6h-2.18c.11-.31.18-.65.18-1 0-1.66-1.34-3-3-3-1.05 0-1.96.54-2.5 1.35l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-5-2c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm11 15H4v-2h16v2zm0-5H4V8h5.08L7 10.83 8.62 12 11 8.76l1-1.36 1 1.36L15.38 12 17 10.83 14.92 8H20v6z");
   var receipt = $Material$Icons$Internal.icon("M18 17H6v-2h12v2zm0-4H6v-2h12v2zm0-4H6V7h12v2zM3 22l1.5-1.5L6 22l1.5-1.5L9 22l1.5-1.5L12 22l1.5-1.5L15 22l1.5-1.5L18 22l1.5-1.5L21 22V2l-1.5 1.5L18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2 4.5 3.5 3 2v20z");
   var question_answer = $Material$Icons$Internal.icon("M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-4 6V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10c.55 0 1-.45 1-1z");
   var query_builder = $Material$Icons$Internal.icon("M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zM12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z");
   var print = $Material$Icons$Internal.icon("M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8v5zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-1-9H6v4h12V3z");
   var power_settings_new = $Material$Icons$Internal.icon("M13 3h-2v10h2V3zm4.83 2.17l-1.42 1.42C17.99 7.86 19 9.81 19 12c0 3.87-3.13 7-7 7s-7-3.13-7-7c0-2.19 1.01-4.14 2.58-5.42L6.17 5.17C4.23 6.82 3 9.26 3 12c0 4.97 4.03 9 9 9s9-4.03 9-9c0-2.74-1.23-5.18-3.17-6.83z");
   var polymer = $Material$Icons$Internal.icon("M19 4h-4L7.11 16.63 4.5 12 9 4H5L.5 12 5 20h4l7.89-12.63L19.5 12 15 20h4l4.5-8z");
   var play_for_work = $Material$Icons$Internal.icon("M11 5v5.59H7.5l4.5 4.5 4.5-4.5H13V5h-2zm-5 9c0 3.31 2.69 6 6 6s6-2.69 6-6h-2c0 2.21-1.79 4-4 4s-4-1.79-4-4H6z");
   var picture_in_picture = $Material$Icons$Internal.icon("M19 7h-8v6h8V7zm2-4H3c-1.1 0-2 .9-2 2v14c0 1.1.9 1.98 2 1.98h18c1.1 0 2-.88 2-1.98V5c0-1.1-.9-2-2-2zm0 16.01H3V4.98h18v14.03z");
   var perm_scan_wifi = $Material$Icons$Internal.icon("M12 3C6.95 3 3.15 4.85 0 7.23L12 22 24 7.25C20.85 4.87 17.05 3 12 3zm1 13h-2v-6h2v6zm-2-8V6h2v2h-2z");
   var perm_phone_msg = $Material$Icons$Internal.icon("M20 15.5c-1.25 0-2.45-.2-3.57-.57-.35-.11-.74-.03-1.02.24l-2.2 2.2c-2.83-1.44-5.15-3.75-6.59-6.58l2.2-2.21c.28-.27.36-.66.25-1.01C8.7 6.45 8.5 5.25 8.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1zM12 3v10l3-3h6V3h-9z");
   var perm_media = $Material$Icons$Internal.icon("M2 6H0v5h.01L0 20c0 1.1.9 2 2 2h18v-2H2V6zm20-2h-8l-2-2H6c-1.1 0-1.99.9-1.99 2L4 16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM7 15l4.5-6 3.5 4.51 2.5-3.01L21 15H7z");
   var perm_identity = $Material$Icons$Internal.icon("M12 5.9c1.16 0 2.1.94 2.1 2.1s-.94 2.1-2.1 2.1S9.9 9.16 9.9 8s.94-2.1 2.1-2.1m0 9c2.97 0 6.1 1.46 6.1 2.1v1.1H5.9V17c0-.64 3.13-2.1 6.1-2.1M12 4C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 9c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4z");
   var perm_device_information = $Material$Icons$Internal.icon("M13 7h-2v2h2V7zm0 4h-2v6h2v-6zm4-9.99L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z");
   var perm_data_setting = $Material$Icons$Internal.icon("M18.99 11.5c.34 0 .67.03 1 .07L20 0 0 20h11.56c-.04-.33-.07-.66-.07-1 0-4.14 3.36-7.5 7.5-7.5zm3.71 7.99c.02-.16.04-.32.04-.49 0-.17-.01-.33-.04-.49l1.06-.83c.09-.08.12-.21.06-.32l-1-1.73c-.06-.11-.19-.15-.31-.11l-1.24.5c-.26-.2-.54-.37-.85-.49l-.19-1.32c-.01-.12-.12-.21-.24-.21h-2c-.12 0-.23.09-.25.21l-.19 1.32c-.3.13-.59.29-.85.49l-1.24-.5c-.11-.04-.24 0-.31.11l-1 1.73c-.06.11-.04.24.06.32l1.06.83c-.02.16-.03.32-.03.49 0 .17.01.33.03.49l-1.06.83c-.09.08-.12.21-.06.32l1 1.73c.06.11.19.15.31.11l1.24-.5c.26.2.54.37.85.49l.19 1.32c.02.12.12.21.25.21h2c.12 0 .23-.09.25-.21l.19-1.32c.3-.13.59-.29.84-.49l1.25.5c.11.04.24 0 .31-.11l1-1.73c.06-.11.03-.24-.06-.32l-1.07-.83zm-3.71 1.01c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z");
   var perm_contact_calendar = $Material$Icons$Internal.icon("M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm6 12H6v-1c0-2 4-3.1 6-3.1s6 1.1 6 3.1v1z");
   var perm_camera_mic = $Material$Icons$Internal.icon("M20 5h-3.17L15 3H9L7.17 5H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v-2.09c-2.83-.48-5-2.94-5-5.91h2c0 2.21 1.79 4 4 4s4-1.79 4-4h2c0 2.97-2.17 5.43-5 5.91V21h7c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm-6 8c0 1.1-.9 2-2 2s-2-.9-2-2V9c0-1.1.9-2 2-2s2 .9 2 2v4z");
   var payment = $Material$Icons$Internal.icon("M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z");
   var pageview = $Material$Icons$Internal.icon("M11.5 9C10.12 9 9 10.12 9 11.5s1.12 2.5 2.5 2.5 2.5-1.12 2.5-2.5S12.88 9 11.5 9zM20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-3.21 14.21l-2.91-2.91c-.69.44-1.51.7-2.39.7C9.01 16 7 13.99 7 11.5S9.01 7 11.5 7 16 9.01 16 11.5c0 .88-.26 1.69-.7 2.39l2.91 2.9-1.42 1.42z");
   var open_with = $Material$Icons$Internal.icon("M10 9h4V6h3l-5-5-5 5h3v3zm-1 1H6V7l-5 5 5 5v-3h3v-4zm14 2l-5-5v3h-3v4h3v3l5-5zm-9 3h-4v3H7l5 5 5-5h-3v-3z");
   var open_in_new = $Material$Icons$Internal.icon("M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z");
   var open_in_browser = $Material$Icons$Internal.icon("M19 4H5c-1.11 0-2 .9-2 2v12c0 1.1.89 2 2 2h4v-2H5V8h14v10h-4v2h4c1.1 0 2-.9 2-2V6c0-1.1-.89-2-2-2zm-7 6l-4 4h3v6h2v-6h3l-4-4z");
   var offline_pin = F2(function (color,size) {
      var stringSize = $Basics.toString(size);
      var stringColor = $Material$Icons$Internal.toRgbaString(color);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 24 24")]),
      _U.list([A2($Svg.defs,_U.list([]),_U.list([A2($Svg.path,_U.list([$Svg$Attributes.id("a"),$Svg$Attributes.d("M0 0h24v24H0V0z")]),_U.list([]))]))
              ,A3($VirtualDom.node,
              "clipPath",
              _U.list([$Svg$Attributes.id("b")]),
              _U.list([A2($Svg.use,_U.list([$Svg$Attributes.xlinkHref("#a"),$Svg$Attributes.overflow("visible")]),_U.list([]))]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm5 16H7v-2h10v2zm-6.7-4L7 10.7l1.4-1.4 1.9 1.9 5.3-5.3L17 7.3 10.3 14z")
                      ,$Svg$Attributes.clipPath("url(#b)")
                      ,$Svg$Attributes.fill(stringColor)]),
              _U.list([]))]));
   });
   var note_add = $Material$Icons$Internal.icon("M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 14h-3v3h-2v-3H8v-2h3v-3h2v3h3v2zm-3-7V3.5L18.5 9H13z");
   var markunread_mailbox = $Material$Icons$Internal.icon("M20 6H10v6H8V4h6V0H6v6H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z");
   var loyalty = $Material$Icons$Internal.icon("M21.41 11.58l-9-9C12.05 2.22 11.55 2 11 2H4c-1.1 0-2 .9-2 2v7c0 .55.22 1.05.59 1.42l9 9c.36.36.86.58 1.41.58.55 0 1.05-.22 1.41-.59l7-7c.37-.36.59-.86.59-1.41 0-.55-.23-1.06-.59-1.42zM5.5 7C4.67 7 4 6.33 4 5.5S4.67 4 5.5 4 7 4.67 7 5.5 6.33 7 5.5 7zm11.77 8.27L13 19.54l-4.27-4.27C8.28 14.81 8 14.19 8 13.5c0-1.38 1.12-2.5 2.5-2.5.69 0 1.32.28 1.77.74l.73.72.73-.73c.45-.45 1.08-.73 1.77-.73 1.38 0 2.5 1.12 2.5 2.5 0 .69-.28 1.32-.73 1.77z");
   var lock_outline = $Material$Icons$Internal.icon("M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6-5.1c1.71 0 3.1 1.39 3.1 3.1v2H9V6h-.1c0-1.71 1.39-3.1 3.1-3.1zM18 20H6V10h12v10zm-6-3c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z");
   var lock_open = $Material$Icons$Internal.icon("M12 17c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm6-9h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6h1.9c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm0 12H6V10h12v10z");
   var lock = $Material$Icons$Internal.icon("M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z");
   var list = $Material$Icons$Internal.icon("M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z");
   var launch = $Material$Icons$Internal.icon("M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z");
   var language = $Material$Icons$Internal.icon("M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm6.93 6h-2.95c-.32-1.25-.78-2.45-1.38-3.56 1.84.63 3.37 1.91 4.33 3.56zM12 4.04c.83 1.2 1.48 2.53 1.91 3.96h-3.82c.43-1.43 1.08-2.76 1.91-3.96zM4.26 14C4.1 13.36 4 12.69 4 12s.1-1.36.26-2h3.38c-.08.66-.14 1.32-.14 2 0 .68.06 1.34.14 2H4.26zm.82 2h2.95c.32 1.25.78 2.45 1.38 3.56-1.84-.63-3.37-1.9-4.33-3.56zm2.95-8H5.08c.96-1.66 2.49-2.93 4.33-3.56C8.81 5.55 8.35 6.75 8.03 8zM12 19.96c-.83-1.2-1.48-2.53-1.91-3.96h3.82c-.43 1.43-1.08 2.76-1.91 3.96zM14.34 14H9.66c-.09-.66-.16-1.32-.16-2 0-.68.07-1.35.16-2h4.68c.09.65.16 1.32.16 2 0 .68-.07 1.34-.16 2zm.25 5.56c.6-1.11 1.06-2.31 1.38-3.56h2.95c-.96 1.65-2.49 2.93-4.33 3.56zM16.36 14c.08-.66.14-1.32.14-2 0-.68-.06-1.34-.14-2h3.38c.16.64.26 1.31.26 2s-.1 1.36-.26 2h-3.38z");
   var label_outline = $Material$Icons$Internal.icon("M17.63 5.84C17.27 5.33 16.67 5 16 5L5 5.01C3.9 5.01 3 5.9 3 7v10c0 1.1.9 1.99 2 1.99L16 19c.67 0 1.27-.33 1.63-.84L22 12l-4.37-6.16zM16 17H5V7h11l3.55 5L16 17z");
   var label = $Material$Icons$Internal.icon("M17.63 5.84C17.27 5.33 16.67 5 16 5L5 5.01C3.9 5.01 3 5.9 3 7v10c0 1.1.9 1.99 2 1.99L16 19c.67 0 1.27-.33 1.63-.84L22 12l-4.37-6.16z");
   var invert_colors = $Material$Icons$Internal.icon("M17.66 7.93L12 2.27 6.34 7.93c-3.12 3.12-3.12 8.19 0 11.31C7.9 20.8 9.95 21.58 12 21.58c2.05 0 4.1-.78 5.66-2.34 3.12-3.12 3.12-8.19 0-11.31zM12 19.59c-1.6 0-3.11-.62-4.24-1.76C6.62 16.69 6 15.19 6 13.59s.62-3.11 1.76-4.24L12 5.1v14.49z");
   var input = $Material$Icons$Internal.icon("M21 3.01H3c-1.1 0-2 .9-2 2V9h2V4.99h18v14.03H3V15H1v4.01c0 1.1.9 1.98 2 1.98h18c1.1 0 2-.88 2-1.98v-14c0-1.11-.9-2-2-2zM11 16l4-4-4-4v3H1v2h10v3z");
   var info_outline = $Material$Icons$Internal.icon("M11 17h2v-6h-2v6zm1-15C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM11 9h2V7h-2v2z");
   var info = $Material$Icons$Internal.icon("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z");
   var https = $Material$Icons$Internal.icon("M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z");
   var http = $Material$Icons$Internal.icon("M4.5 11h-2V9H1v6h1.5v-2.5h2V15H6V9H4.5v2zm2.5-.5h1.5V15H10v-4.5h1.5V9H7v1.5zm5.5 0H14V15h1.5v-4.5H17V9h-4.5v1.5zm9-1.5H18v6h1.5v-2h2c.8 0 1.5-.7 1.5-1.5v-1c0-.8-.7-1.5-1.5-1.5zm0 2.5h-2v-1h2v1z");
   var hourglass_full = $Material$Icons$Internal.icon("M6 2v6h.01L6 8.01 10 12l-4 4 .01.01H6V22h12v-5.99h-.01L18 16l-4-4 4-3.99-.01-.01H18V2H6z");
   var hourglass_empty = $Material$Icons$Internal.icon("M6 2v6h.01L6 8.01 10 12l-4 4 .01.01H6V22h12v-5.99h-.01L18 16l-4-4 4-3.99-.01-.01H18V2H6zm10 14.5V20H8v-3.5l4-4 4 4zm-4-5l-4-4V4h8v3.5l-4 4z");
   var home = $Material$Icons$Internal.icon("M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z");
   var history = F2(function (color,size) {
      var stringSize = $Basics.toString(size);
      var stringColor = $Material$Icons$Internal.toRgbaString(color);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 24 24")]),
      _U.list([A2($Svg.path,
      _U.list([$Svg$Attributes.opacity(".9")
   ...
   var highlight_off = $Material$Icons$Internal.icon("M14.59 8L12 10.59 9.41 8 8 9.41 10.59 12 8 14.59 9.41 16 12 13.41 14.59 16 16 14.59 13.41 12 16 9.41 14.59 8zM12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z");
   var help_outline = $Material$Icons$Internal.icon("M11 18h2v-2h-2v2zm1-16C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-14c-2.21 0-4 1.79-4 4h2c0-1.1.9-2 2-2s2 .9 2 2c0 2-3 1.75-3 5h2c0-2.25 3-2.5 3-5 0-2.21-1.79-4-4-4z");
   var help = $Material$Icons$Internal.icon("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z");
   var group_work = $Material$Icons$Internal.icon("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM8 17.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5zM9.5 8c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5S9.5 9.38 9.5 8zm6.5 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z");
   var grade = $Material$Icons$Internal.icon("M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z");
   var gif = F2(function (color,size) {
      var stringSize = $Basics.toString(size);
      var stringColor = $Material$Icons$Internal.toRgbaString(color);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 24 24")]),
      _U.list([A2($Svg.defs,_U.list([]),_U.list([A2($Svg.path,_U.list([$Svg$Attributes.id("a"),$Svg$Attributes.d("M24 24H0V0h24v24z")]),_U.list([]))]))
              ,A3($VirtualDom.node,
              "clipPath",
              _U.list([$Svg$Attributes.id("b")]),
              _U.list([A2($Svg.use,_U.list([$Svg$Attributes.xlinkHref("#a"),$Svg$Attributes.overflow("visible")]),_U.list([]))]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M11.5 9H13v6h-1.5zM9 9H6c-.6 0-1 .5-1 1v4c0 .5.4 1 1 1h3c.6 0 1-.5 1-1v-2H8.5v1.5h-2v-3H10V10c0-.5-.4-1-1-1zm10 1.5V9h-4.5v6H16v-2h2v-1.5h-2v-1z")
                      ,$Svg$Attributes.clipPath("url(#b)")
                      ,$Svg$Attributes.fill(stringColor)]),
              _U.list([]))]));
   });
   var get_app = $Material$Icons$Internal.icon("M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z");
   var flip_to_front = $Material$Icons$Internal.icon("M3 13h2v-2H3v2zm0 4h2v-2H3v2zm2 4v-2H3c0 1.1.89 2 2 2zM3 9h2V7H3v2zm12 12h2v-2h-2v2zm4-18H9c-1.11 0-2 .9-2 2v10c0 1.1.89 2 2 2h10c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 12H9V5h10v10zm-8 6h2v-2h-2v2zm-4 0h2v-2H7v2z");
   var flip_to_back = $Material$Icons$Internal.icon("M9 7H7v2h2V7zm0 4H7v2h2v-2zm0-8c-1.11 0-2 .9-2 2h2V3zm4 12h-2v2h2v-2zm6-12v2h2c0-1.1-.9-2-2-2zm-6 0h-2v2h2V3zM9 17v-2H7c0 1.1.89 2 2 2zm10-4h2v-2h-2v2zm0-4h2V7h-2v2zm0 8c1.1 0 2-.9 2-2h-2v2zM5 7H3v12c0 1.1.89 2 2 2h12v-2H5V7zm10-2h2V3h-2v2zm0 12h2v-2h-2v2z");
   var flight_takeoff = F2(function (color,size) {
      var stringSize = $Basics.toString(size);
      var stringColor = $Material$Icons$Internal.toRgbaString(color);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 24 24")]),
      _U.list([A2($Svg.defs,_U.list([]),_U.list([A2($Svg.path,_U.list([$Svg$Attributes.id("a"),$Svg$Attributes.d("M0 0h24v24H0V0z")]),_U.list([]))]))
              ...
              _U.list([A2($Svg.use,_U.list([$Svg$Attributes.xlinkHref("#a"),$Svg$Attributes.overflow("visible")]),_U.list([]))]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M2.5 19h19v2h-19zm19.57-9.36c-.21-.8-1.04-1.28-1.84-1.06L14.92 10l-6.9-6.43-1.93.51 4.14 7.17-4.97 1.33-1.97-1.54-1.45.39 1.82 3.16.77 1.33 1.6-.43 5.31-1.42 4.35-1.16L21 11.49c.81-.23 1.28-1.05 1.07-1.85z")
                      ,$Svg$Attributes.clipPath("url(#b)")
                      ,$Svg$Attributes.fill(stringColor)]),
              _U.list([]))]));
   });
   var flight_land = F2(function (color,size) {
      var stringSize = $Basics.toString(size);
      var stringColor = $Material$Icons$Internal.toRgbaString(color);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 24 24")]),
      _U.list([A2($Svg.defs,_U.list([]),_U.list([A2($Svg.path,_U.list([$Svg$Attributes.id("a"),$Svg$Attributes.d("M0 0h24v24H0V0z")]),_U.list([]))]))
              ,A2($Svg.defs,_U.list([]),_U.list([A2($Svg.path,_U.list([$Svg$Attributes.id("c"),$Svg$Attributes.d("M0 0h24v24H0V0z")]),_U.list([]))]))
              ,A3($VirtualDom.node,
              "clipPath",
              _U.list([$Svg$Attributes.id("b")]),
              _U.list([A2($Svg.use,_U.list([$Svg$Attributes.xlinkHref("#a"),$Svg$Attributes.overflow("visible")]),_U.list([]))]))
              ,A3($VirtualDom.node,
              "clipPath",
              _U.list([$Svg$Attributes.id("d"),$Svg$Attributes.clipPath("url(#b)")]),
              _U.list([A2($Svg.use,_U.list([$Svg$Attributes.xlinkHref("#c"),$Svg$Attributes.overflow("visible")]),_U.list([]))]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M2.5 19h19v2h-19zm7.18-5.73l4.35 1.16 5.31 1.42c.8.21 1.62-.26 1.84-1.06.21-.8-.26-1.62-1.06-1.84l-5.31-1.42-2.76-9.02L10.12 2v8.28L5.15 8.95l-.93-2.32-1.45-.39v5.17l1.6.43 5.31 1.43z")
   ...
   var find_in_page = $Material$Icons$Internal.icon("M20 19.59V8l-6-6H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c.45 0 .85-.15 1.19-.4l-4.43-4.43c-.8.52-1.74.83-2.76.83-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5c0 1.02-.31 1.96-.83 2.75L20 19.59zM9 13c0 1.66 1.34 3 3 3s3-1.34 3-3-1.34-3-3-3-3 1.34-3 3z");
   var feedback = $Material$Icons$Internal.icon("M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 12h-2v-2h2v2zm0-4h-2V6h2v4z");
   var favorite_border = $Material$Icons$Internal.icon("M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z");
   var favorite = $Material$Icons$Internal.icon("M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z");
   var face = $Material$Icons$Internal.icon("M9 11.75c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25zm6 0c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8 0-.29.02-.58.05-.86 2.36-1.05 4.23-2.98 5.21-5.37C11.07 8.33 14.05 10 17.42 10c.78 0 1.53-.09 2.25-.26.21.71.33 1.47.33 2.26 0 4.41-3.59 8-8 8z");
   var extension = $Material$Icons$Internal.icon("M20.5 11H19V7c0-1.1-.9-2-2-2h-4V3.5C13 2.12 11.88 1 10.5 1S8 2.12 8 3.5V5H4c-1.1 0-1.99.9-1.99 2v3.8H3.5c1.49 0 2.7 1.21 2.7 2.7s-1.21 2.7-2.7 2.7H2V20c0 1.1.9 2 2 2h3.8v-1.5c0-1.49 1.21-2.7 2.7-2.7 1.49 0 2.7 1.21 2.7 2.7V22H17c1.1 0 2-.9 2-2v-4h1.5c1.38 0 2.5-1.12 2.5-2.5S21.88 11 20.5 11z");
   var explore = $Material$Icons$Internal.icon("M12 10.9c-.61 0-1.1.49-1.1 1.1s.49 1.1 1.1 1.1c.61 0 1.1-.49 1.1-1.1s-.49-1.1-1.1-1.1zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm2.19 12.19L6 18l3.81-8.19L18 6l-3.81 8.19z");
   var exit_to_app = $Material$Icons$Internal.icon("M10.09 15.59L11.5 17l5-5-5-5-1.41 1.41L12.67 11H3v2h9.67l-2.58 2.59zM19 3H5c-1.11 0-2 .9-2 2v4h2V5h14v14H5v-4H3v4c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z");
   var event_seat = F2(function (color,size) {
      var stringColor = $Material$Icons$Internal.toRgbaString(color);
      var stringSize = $Basics.toString(size);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(stringSize),$Svg$Attributes.height(stringSize),$Svg$Attributes.viewBox("0 0 24 24")]),
      _U.list([A2($Svg.defs,_U.list([]),_U.list([A2($Svg.path,_U.list([$Svg$Attributes.id("a"),$Svg$Attributes.d("M0 0h24v24H0V0z")]),_U.list([]))]))
              ...
              _U.list([A2($Svg.use,_U.list([$Svg$Attributes.xlinkHref("#a"),$Svg$Attributes.overflow("visible")]),_U.list([]))]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M4 18v3h3v-3h10v3h3v-6H4zm15-8h3v3h-3zM2 10h3v3H2zm15 3H7V5c0-1.1.9-2 2-2h6c1.1 0 2 .9 2 2v8z")
                      ,$Svg$Attributes.clipPath("url(#b)")
                      ,$Svg$Attributes.fill(stringColor)]),
              _U.list([]))]));
   });
   var event = $Material$Icons$Internal.icon("M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z");
   var eject = $Material$Icons$Internal.icon("M5 17h14v2H5zm7-12L5.33 15h13.34z");
   var done_all = $Material$Icons$Internal.icon("M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.66 16.17 7.48 12l-1.41 1.41L11.66 19l12-12-1.42-1.41zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z");
   var done = $Material$Icons$Internal.icon("M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z");
   var dns = $Material$Icons$Internal.icon("M20 13H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zM7 19c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM20 3H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zM7 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z");
   var description = $Material$Icons$Internal.icon("M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z");
   var $delete = $Material$Icons$Internal.icon("M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z");
   var dashboard = $Material$Icons$Internal.icon("M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z");
   var credit_card = $Material$Icons$Internal.icon("M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z");
   var code = $Material$Icons$Internal.icon("M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z");
   var $class = $Material$Icons$Internal.icon("M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z");
   var chrome_reader_mode = $Material$Icons$Internal.icon("M13 12h7v1.5h-7zm0-2.5h7V11h-7zm0 5h7V16h-7zM21 4H3c-1.1 0-2 .9-2 2v13c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 15h-9V6h9v13z");
   var check_circle = $Material$Icons$Internal.icon("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z");
   var change_history = $Material$Icons$Internal.icon("M12 7.77L18.39 18H5.61L12 7.77M12 4L2 20h20L12 4z");
   var card_travel = $Material$Icons$Internal.icon("M20 6h-3V4c0-1.11-.89-2-2-2H9c-1.11 0-2 .89-2 2v2H4c-1.11 0-2 .89-2 2v11c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zM9 4h6v2H9V4zm11 15H4v-2h16v2zm0-5H4V8h3v2h2V8h6v2h2V8h3v6z");
   var card_membership = $Material$Icons$Internal.icon("M20 2H4c-1.11 0-2 .89-2 2v11c0 1.11.89 2 2 2h4v5l4-2 4 2v-5h4c1.11 0 2-.89 2-2V4c0-1.11-.89-2-2-2zm0 13H4v-2h16v2zm0-5H4V4h16v6z");
   var card_giftcard = $Material$Icons$Internal.icon("M20 6h-2.18c.11-.31.18-.65.18-1 0-1.66-1.34-3-3-3-1.05 0-1.96.54-2.5 1.35l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-5-2c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm11 15H4v-2h16v2zm0-5H4V8h5.08L7 10.83 8.62 12 11 8.76l1-1.36 1 1.36L15.38 12 17 10.83 14.92 8H20v6z");
   var camera_enhance = $Material$Icons$Internal.icon("M9 3L7.17 5H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2h-3.17L15 3H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zM12 17l1.25-2.75L16 13l-2.75-1.25L12 9l-1.25 2.75L8 13l2.75 1.25z");
   var cached = $Material$Icons$Internal.icon("M19 8l-4 4h3c0 3.31-2.69 6-6 6-1.01 0-1.97-.25-2.8-.7l-1.46 1.46C8.97 19.54 10.43 20 12 20c4.42 0 8-3.58 8-8h3l-4-4zM6 12c0-3.31 2.69-6 6-6 1.01 0 1.97.25 2.8.7l1.46-1.46C15.03 4.46 13.57 4 12 4c-4.42 0-8 3.58-8 8H1l4 4 4-4H6z");
   var build = $Material$Icons$Internal.icon("M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z");
   var bug_report = $Material$Icons$Internal.icon("M20 8h-2.81c-.45-.78-1.07-1.45-1.82-1.96L17 4.41 15.59 3l-2.17 2.17C12.96 5.06 12.49 5 12 5c-.49 0-.96.06-1.41.17L8.41 3 7 4.41l1.62 1.63C7.88 6.55 7.26 7.22 6.81 8H4v2h2.09c-.05.33-.09.66-.09 1v1H4v2h2v1c0 .34.04.67.09 1H4v2h2.81c1.04 1.79 2.97 3 5.19 3s4.15-1.21 5.19-3H20v-2h-2.09c.05-.33.09-.66.09-1v-1h2v-2h-2v-1c0-.34-.04-.67-.09-1H20V8zm-6 8h-4v-2h4v2zm0-4h-4v-2h4v2z");
   var bookmark_border = $Material$Icons$Internal.icon("M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2zm0 15l-5-2.18L7 18V5h10v13z");
   var bookmark = $Material$Icons$Internal.icon("M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2z");
   var book = $Material$Icons$Internal.icon("M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z");
   var backup = $Material$Icons$Internal.icon("M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z");
   var autorenew = $Material$Icons$Internal.icon("M12 6v3l4-4-4-4v3c-4.42 0-8 3.58-8 8 0 1.57.46 3.03 1.24 4.26L6.7 14.8c-.45-.83-.7-1.79-.7-2.8 0-3.31 2.69-6 6-6zm6.76 1.74L17.3 9.2c.44.84.7 1.79.7 2.8 0 3.31-2.69 6-6 6v-3l-4 4 4 4v-3c4.42 0 8-3.58 8-8 0-1.57-.46-3.03-1.24-4.26z");
   var assignment_turned_in = $Material$Icons$Internal.icon("M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm-2 14l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z");
   var assignment_returned = $Material$Icons$Internal.icon("M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm0 15l-5-5h3V9h4v4h3l-5 5z");
   var assignment_return = $Material$Icons$Internal.icon("M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm4 12h-4v3l-5-5 5-5v3h4v4z");
   var assignment_late = $Material$Icons$Internal.icon("M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-6 15h-2v-2h2v2zm0-4h-2V8h2v6zm-1-9c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z");
   var assignment_ind = $Material$Icons$Internal.icon("M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm0 4c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm6 12H6v-1.4c0-2 4-3.1 6-3.1s6 1.1 6 3.1V19z");
   var assignment = $Material$Icons$Internal.icon("M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z");
   var assessment = $Material$Icons$Internal.icon("M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z");
   var aspect_ratio = $Material$Icons$Internal.icon("M19 12h-2v3h-3v2h5v-5zM7 9h3V7H5v5h2V9zm14-6H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16.01H3V4.99h18v14.02z");
   var announcement = $Material$Icons$Internal.icon("M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 9h-2V5h2v6zm0 4h-2v-2h2v2z");
   var android = $Material$Icons$Internal.icon("M6 18c0 .55.45 1 1 1h1v3.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5V19h2v3.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5V19h1c.55 0 1-.45 1-1V8H6v10zM3.5 8C2.67 8 2 8.67 2 9.5v7c0 .83.67 1.5 1.5 1.5S5 17.33 5 16.5v-7C5 8.67 4.33 8 3.5 8zm17 0c-.83 0-1.5.67-1.5 1.5v7c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5v-7c0-.83-.67-1.5-1.5-1.5zm-4.97-5.84l1.3-1.3c.2-.2.2-.51 0-.71-.2-.2-.51-.2-.71 0l-1.48 1.48C13.85 1.23 12.95 1 12 1c-.96 0-1.86.23-2.66.63L7.85.15c-.2-.2-.51-.2-.71 0-.2.2-.2.51 0 .71l1.31 1.31C6.97 3.26 6 5.01 6 7h12c0-1.99-.97-3.75-2.47-4.84zM10 5H9V4h1v1zm5 0h-1V4h1v1z");
   var alarm_on = $Material$Icons$Internal.icon("M22 5.72l-4.6-3.86-1.29 1.53 4.6 3.86L22 5.72zM7.88 3.39L6.6 1.86 2 5.71l1.29 1.53 4.59-3.85zM12 4c-4.97 0-9 4.03-9 9s4.02 9 9 9c4.97 0 9-4.03 9-9s-4.03-9-9-9zm0 16c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7zm-1.46-5.47L8.41 12.4l-1.06 1.06 3.18 3.18 6-6-1.06-1.06-4.93 4.95z");
   ...
   var alarm_add = $Material$Icons$Internal.icon("M7.88 3.39L6.6 1.86 2 5.71l1.29 1.53 4.59-3.85zM22 5.72l-4.6-3.86-1.29 1.53 4.6 3.86L22 5.72zM12 4c-4.97 0-9 4.03-9 9s4.02 9 9 9c4.97 0 9-4.03 9-9s-4.03-9-9-9zm0 16c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7zm1-11h-2v3H8v2h3v3h2v-3h3v-2h-3V9z");
   var alarm = $Material$Icons$Internal.icon("M22 5.72l-4.6-3.86-1.29 1.53 4.6 3.86L22 5.72zM7.88 3.39L6.6 1.86 2 5.71l1.29 1.53 4.59-3.85zM12.5 8H11v6l4.75 2.85.75-1.23-4-2.37V8zM12 4c-4.97 0-9 4.03-9 9s4.02 9 9 9c4.97 0 9-4.03 9-9s-4.03-9-9-9zm0 16c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z");
   var add_shopping_cart = $Material$Icons$Internal.icon("M11 9h2V6h3V4h-3V1h-2v3H8v2h3v3zm-4 9c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2zm-9.83-3.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.86-7.01L19.42 4h-.01l-1.1 2-2.76 5H8.53l-.13-.27L6.16 6l-.95-2-.94-2H1v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.13 0-.25-.11-.25-.25z");
   var account_circle = $Material$Icons$Internal.icon("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z");
   var account_box = $Material$Icons$Internal.icon("M3 5v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.11 0-2 .9-2 2zm12 4c0 1.66-1.34 3-3 3s-3-1.34-3-3 1.34-3 3-3 3 1.34 3 3zm-9 8c0-2 4-3.1 6-3.1s6 1.1 6 3.1v1H6v-1z");
   var account_balance_with_wallet = $Material$Icons$Internal.icon("M21 18v1c0 1.1-.9 2-2 2H5c-1.11 0-2-.9-2-2V5c0-1.1.89-2 2-2h14c1.1 0 2 .9 2 2v1h-9c-1.11 0-2 .9-2 2v8c0 1.1.89 2 2 2h9zm-9-2h10V8H12v8zm4-2.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z");
   var account_balance = $Material$Icons$Internal.icon("M4 10v7h3v-7H4zm6 0v7h3v-7h-3zM2 22h19v-3H2v3zm14-12v7h3v-7h-3zm-4.5-9L2 6v2h19V6l-9.5-5z");
   var accessibility = $Material$Icons$Internal.icon("M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z");
   var three_d_rotation = $Material$Icons$Internal.icon("M7.52 21.48C4.25 19.94 1.91 16.76 1.55 13H.05C.56 19.16 5.71 24 12 24l.66-.03-3.81-3.81-1.33 1.32zm.89-6.52c-.19 0-.37-.03-.52-.08-.16-.06-.29-.13-.4-.24-.11-.1-.2-.22-.26-.37-.06-.14-.09-.3-.09-.47h-1.3c0 .36.07.68.21.95.14.27.33.5.56.69.24.18.51.32.82.41.3.1.62.15.96.15.37 0 .72-.05 1.03-.15.32-.1.6-.25.83-.44s.42-.43.55-.72c.13-.29.2-.61.2-.97 0-.19-.02-.38-.07-.56-.05-.18-.12-.35-.23-.51-.1-.16-.24-.3-.4-.43-.17-.13-.37-.23-.61-.31.2-.09.37-.2.52-.33.15-.13.27-.27.37-.42.1-.15.17-.3.22-.46.05-.16.07-.32.07-.48 0-.36-.06-.68-.18-.96-.12-.28-.29-.51-.51-.69-.2-.19-.47-.33-.77-.43C9.1 8.05 8.76 8 8.39 8c-.36 0-.69.05-1 .16-.3.11-.57.26-.79.45-.21.19-.38.41-.51.67-.12.26-.18.54-.18.85h1.3c0-.17.03-.32.09-.45s.14-.25.25-.34c.11-.09.23-.17.38-.22.15-.05.3-.08.48-.08.4 0 .7.1.89.31.19.2.29.49.29.86 0 .18-.03.34-.08.49-.05.15-.14.27-.25.37-.11.1-.25.18-.41.24-.16.06-.36.09-.58.09H7.5v1.03h.77c.22 0 .42.02.6.07s.33.13.45.23c.12.11.22.24.29.4.07.16.1.35.1.57 0 .41-.12.72-.35.93-.23.23-.55.33-.95.33zm8.55-5.92c-.32-.33-.7-.59-1.14-.77-.43-.18-.92-.27-1.46-.27H12v8h2.3c.55 0 1.06-.09 1.51-.27.45-.18.84-.43 1.16-.76.32-.33.57-.73.74-1.19.17-.47.26-.99.26-1.57v-.4c0-.58-.09-1.1-.26-1.57-.18-.47-.43-.87-.75-1.2zm-.39 3.16c0 .42-.05.79-.14 1.13-.1.33-.24.62-.43.85-.19.23-.43.41-.71.53-.29.12-.62.18-.99.18h-.91V9.12h.97c.72 0 1.27.23 1.64.69.38.46.57 1.12.57 1.99v.4zM12 0l-.66.03 3.81 3.81 1.33-1.33c3.27 1.55 5.61 4.72 5.96 8.48h1.5C23.44 4.84 18.29 0 12 0z");
   return _elm.Material.Icons.Action.values = {_op: _op
                                              ,three_d_rotation: three_d_rotation
                                              ,accessibility: accessibility
                                              ,account_balance: account_balance
                                              ,account_balance_with_wallet: account_balance_with_wallet
...
Elm.Css.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var fullWidth = $Html$Attributes.$class("u-full-width");
   var columnImage = $Html$Attributes.$class("u-max-full-width");
   var numberWord = $Array.fromList(_U.list(["one","two","three","four","five","six","seven","eight","nine","ten","eleven"]));
   var column = function (num) {
      return $Html$Attributes.$class(A2($Basics._op["++"],
      A2($Maybe.withDefault,"one",A2($Array.get,num - 1,numberWord)),
      A2($Basics._op["++"]," column",!_U.eq(num,1) ? "s" : "")));
   };
   var row = $Html$Attributes.$class("row");
   var container = $Html$Attributes.$class("container");
   return _elm.Css.values = {_op: _op,container: container,row: row,column: column,numberWord: numberWord,columnImage: columnImage,fullWidth: fullWidth};
};
Elm.CustomStartApp = Elm.CustomStartApp || {};
Elm.CustomStartApp.make = function (_elm) {
   "use strict";
   _elm.CustomStartApp = _elm.CustomStartApp || {};
   if (_elm.CustomStartApp.values) return _elm.CustomStartApp.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var listFairMerge = A2($List.foldr,$Signal$Extra.fairMerge(F2(function (l,r) {    return A2($Basics._op["++"],l,r);})),$Signal.constant(_U.list([])));
   var start = function (config) {
      ...
      var inputs = listFairMerge(A2($List._op["::"],messages.signal,A2($List.map,$Signal.map(singleton),config.inputs)));
      var effectsAndModel = A3($Signal$Extra.foldp$,update,config.init,inputs);
   ...
   return _elm.CustomStartApp.values = {_op: _op,start: start,Config: Config,App: App};
};
Elm.Urls = Elm.Urls || {};
Elm.Urls.make = function (_elm) {
   "use strict";
   _elm.Urls = _elm.Urls || {};
   if (_elm.Urls.values) return _elm.Urls.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var searchDocuments = F2(function (query,tagPks) {
      return A2($Basics._op["++"],
      "/search_documents/",
...
Elm.Database.Tag.make = function (_elm) {
   "use strict";
   _elm.Database = _elm.Database || {};
   _elm.Database.Tag = _elm.Database.Tag || {};
   if (_elm.Database.Tag.values) return _elm.Database.Tag.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var _op = {};
   var view = F2(function (haveLink,tag) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("tag-cont")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("tag")]),
      _U.list([haveLink ? A2($Html.a,
      _U.list([$Html$Attributes.href($Urls.docsWithTag(tag.pk)),$Html$Attributes.$class("link")]),
      _U.list([$Html.text(tag.label)])) : $Html.text(tag.label)]))]));
   });
   var Error = {ctor: "Error"};
   var OTHER = {ctor: "OTHER"};
   var CNTNT = {ctor: "CNTNT"};
   var SBJCT = {ctor: "SBJCT"};
   var GRADE = {ctor: "GRADE"};
   var decodeKind = function (s) {
      var _p0 = s;
      switch (_p0)
      {case "GRADE": return GRADE;
         case "SBJCT": return SBJCT;
         case "CNTNT": return CNTNT;
         case "OTHER": return OTHER;
         default: return A2($Debug.log,"Unknown Kind in Tag decoding",Error);}
   };
   var Tag = F3(function (a,b,c) {    return {label: a,kind: b,pk: c};});
   var decoder = A4($Json$Decode.object3,
   F3(function (l,k,p) {    return A3(Tag,l,decodeKind(k),p);}),
   A2($Json$Decode.at,_U.list(["fields","label"]),$Json$Decode.string),
   A2($Json$Decode.at,_U.list(["fields","kind"]),$Json$Decode.string),
   A2($Json$Decode._op[":="],"pk",$Json$Decode.$int));
   return _elm.Database.Tag.values = {_op: _op
                                     ,Tag: Tag
                                     ,GRADE: GRADE
                                     ,SBJCT: SBJCT
                                     ,CNTNT: CNTNT
...
Elm.Database = Elm.Database || {};
Elm.Database.Document = Elm.Database.Document || {};
Elm.Database.Document.make = function (_elm) {
   "use strict";
   _elm.Database = _elm.Database || {};
   _elm.Database.Document = _elm.Database.Document || {};
   if (_elm.Database.Document.values) return _elm.Database.Document.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Css = Elm.Css.make(_elm),
   $Database$Tag = Elm.Database.Tag.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Urls = Elm.Urls.make(_elm);
   var _op = {};
   var dateView = function (doc) {
      return $Html.text(A2($Basics._op["++"],A3($String.slice,-9,-1,doc.date_added),A2($Basics._op["++"]," ",A3($String.slice,0,10,doc.date_added))));
   };
   var ratingView = function (doc) {
      var rating = A2($Basics._op["++"],$Basics.toString($Basics.round(doc.rating * 100)),"%");
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("rating-cont")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("rating")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: rating},{ctor: "_Tuple2",_0: "background-color",_1: "#f1c40f"}]))
                      ,$Html$Attributes.$class("rating")]),
              _U.list([]))]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("rating-text")]),_U.list([$Html.text(rating)]))]));
   };
   var detailView = function (doc) {
      return A2($Html.ul,
      _U.list([$Html$Attributes.$class("detail-view")]),
      _U.list([A2($Html.li,_U.list([]),_U.list([A2($Html.div,_U.list([$Html$Attributes.$class("row rating-cont")]),_U.list([ratingView(doc)]))]))
              ,A2($Html.li,_U.list([]),_U.list([A2($Html.div,_U.list([$Css.row]),A2($List.map,$Database$Tag.view(true),doc.tags))]))
              ,A2($Html.li,_U.list([]),_U.list([dateView(doc)]))]));
   };
   var preview = function (doc) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("document-preview-cont")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("document-preview row")]),
      _U.list([A2($Html.div,
              _U.list([$Css.column(8)]),
              _U.list([A2($Html.div,
                      _U.list([$Css.row]),
                      _U.list([A2($Html.a,
                      _U.list([$Html$Attributes.href($Urls.document(doc.pk)),$Html$Attributes.$class("link")]),
                      _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text(doc.name)]))]))]))
                      ,A2($Html.div,_U.list([$Css.row]),_U.list([$Html.text(doc.description)]))]))
              ,A2($Html.div,_U.list([$Css.column(4)]),_U.list([detailView(doc)]))]))]));
   };
   var Document = F8(function (a,b,c,d,e,f,g,h) {    return {tags: a,content: b,date_added: c,rating: d,authorPk: e,name: f,description: g,pk: h};});
   var empty = A8(Document,_U.list([]),"","",0,0,"","",0);
   var decoder = A9($Json$Decode.object8,
   Document,
   A2($Json$Decode._op[":="],"expanded_tags",$Json$Decode.list($Database$Tag.decoder)),
   A2($Json$Decode.at,_U.list(["fields","content"]),$Json$Decode.string),
   A2($Json$Decode.at,_U.list(["fields","date_added"]),$Json$Decode.string),
   A2($Json$Decode.at,_U.list(["fields","rating"]),$Json$Decode.$float),
   A2($Json$Decode.at,_U.list(["fields","author"]),$Json$Decode.$int),
   A2($Json$Decode.at,_U.list(["fields","name"]),$Json$Decode.string),
   A2($Json$Decode.at,_U.list(["fields","description"]),$Json$Decode.string),
   A2($Json$Decode._op[":="],"pk",$Json$Decode.$int));
   return _elm.Database.Document.values = {_op: _op
                                          ,Document: Document
                                          ,empty: empty
                                          ,decoder: decoder
...
Elm.EffectsUtil = Elm.EffectsUtil || {};
Elm.EffectsUtil.make = function (_elm) {
   "use strict";
   _elm.EffectsUtil = _elm.EffectsUtil || {};
   if (_elm.EffectsUtil.values) return _elm.EffectsUtil.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F3(function (updateOutModel,tagAction,_p0) {
      var _p1 = _p0;
      return {ctor: "_Tuple2",_0: updateOutModel(_p1._0),_1: A2($Effects.map,tagAction,_p1._1)};
   });
   var noFx = function (model) {    return {ctor: "_Tuple2",_0: model,_1: $Effects.none};};
   return _elm.EffectsUtil.values = {_op: _op,noFx: noFx,update: update};
};
Elm.SharedView = Elm.SharedView || {};
Elm.SharedView.make = function (_elm) {
   "use strict";
   _elm.SharedView = _elm.SharedView || {};
   if (_elm.SharedView.values) return _elm.SharedView.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Css = Elm.Css.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Urls = Elm.Urls.make(_elm);
   var _op = {};
   var footer = A2($Html.footer,
   _U.list([]),
   A2(F2(function (x,y) {    return A2($Basics._op["++"],x,y);}),
   _U.list([A2($Html.hr,_U.list([]),_U.list([]))]),
   A2($List.map,
   function (s) {
      return A2($Html.p,_U.list([]),$List$Extra.singleton($Html.text(s)));
   },
   _U.list(["By Sandi Dušić, Manuel Žic & Marin Sinožić","Copyright © 2016"]))));
   var header = A2($Html.div,
   _U.list([]),
   _U.list([A2($Html.div,
           _U.list([$Css.row,$Html$Attributes.id("header")]),
           _U.list([A2($Html.div,
                   _U.list([$Css.column(2)]),
                   _U.list([A2($Html.a,
...
Elm.TagSelector.make = function (_elm) {
   "use strict";
   _elm.TagSelector = _elm.TagSelector || {};
   if (_elm.TagSelector.values) return _elm.TagSelector.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Css = Elm.Css.make(_elm),
   $Database$Tag = Elm.Database.Tag.make(_elm),
   ...
   $Urls = Elm.Urls.make(_elm);
   var _op = {};
   var tagView = F3(function (actionF,address,tag) {
      return A2($Html.div,
      _U.list([A2($Html$Events.onClick,address,actionF(tag)),$Html$Attributes.$class("tag-cont-cont")]),
      $List$Extra.singleton(A2($Database$Tag.view,false,tag)));
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "UpdateSuggestions": if (_p0._0.ctor === "Ok") {
                 return $EffectsUtil.noFx(_U.update(model,{suggestions: _p0._0._0}));
              } else {
                 return A2($Debug.log,$Basics.toString(_p0._0._0),$EffectsUtil.noFx(model));
              }
         case "AddTag": var _p1 = _p0._0;
           return A2($List.all,function (t) {    return !_U.eq(t.pk,_p1.pk);},model.selected) ? $EffectsUtil.noFx(_U.update(model,
           {selected: A2($List._op["::"],_p1,model.selected)})) : $EffectsUtil.noFx(model);
         default: return $EffectsUtil.noFx(_U.update(model,{selected: A2($List.filter,function (t) {    return !_U.eq(t.pk,_p0._0.pk);},model.selected)}));}
   });
   var RemoveTag = function (a) {    return {ctor: "RemoveTag",_0: a};};
   var AddTag = function (a) {    return {ctor: "AddTag",_0: a};};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("tag-selector")]),
      _U.list([$List.isEmpty(model.selected) ? A2($Html.div,_U.list([]),_U.list([])) : A2($Html.div,
              _U.list([$Html$Attributes.$class("row tag-selector-row")]),
              A2($List.map,A2(tagView,RemoveTag,address),$List.reverse(model.selected)))
              ,A2($Html.div,
              _U.list([]),
              A2($List.map,
              function (_p2) {
                 ...
                 return A2($Html.div,
                 _U.list([$Html$Attributes.$class("row tag-selector-row")]),
                 _U.list([A2($Html.div,_U.list([$Css.column(1)]),$List$Extra.singleton($Html.text(A2($Basics._op["++"],_p3.label,":"))))
                         ,A2($Html.div,_U.list([$Css.column(10)]),A2($List.map,A2(tagView,AddTag,address),_p3.list))]));
              },
              model.suggestions))]));
   });
   var UpdateSuggestions = function (a) {    return {ctor: "UpdateSuggestions",_0: a};};
   var Suggestion = F2(function (a,b) {    return {list: a,label: b};});
   var decoder = $Json$Decode.list(A3($Json$Decode.object2,
   Suggestion,
   A2($Json$Decode._op[":="],"list",$Json$Decode.list($Database$Tag.decoder)),
   A2($Json$Decode._op[":="],"label",$Json$Decode.string)));
   var Model = F2(function (a,b) {    return {selected: a,suggestions: b};});
   var init = {ctor: "_Tuple2"
              ,_0: A2(Model,_U.list([]),_U.list([]))
              ,_1: $Effects.task(A2($Task.map,UpdateSuggestions,$Task.toResult(A2($Http.get,decoder,$Urls.suggestedTags))))};
   return _elm.TagSelector.values = {_op: _op
                                    ,Model: Model
...
Elm.Search.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Css = Elm.Css.make(_elm),
   $Database$Document = Elm.Database.Document.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $EffectsUtil = Elm.EffectsUtil.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var NewSearchResults = function (a) {    return {ctor: "NewSearchResults",_0: a};};
   var getDocuments = function (model) {
      return $Effects.task(A2($Task.map,
      NewSearchResults,
      $Task.toResult(A2($Http.get,
      $Json$Decode.list($Database$Document.decoder),
      A2($Urls.searchDocuments,model.query,A2($List.map,function (_) {    return _.pk;},model.tagSelector.selected))))));
   };
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "InputChange": var model$ = _U.update(model,{query: _p0._0});
           return {ctor: "_Tuple2",_0: model$,_1: getDocuments(model$)};
         case "NewSearchResults": if (_p0._0.ctor === "Ok") {
                 return $EffectsUtil.noFx(_U.update(model,{documents: _p0._0._0}));
              } else {
                 return $EffectsUtil.noFx(A2($Debug.log,$Basics.toString(_p0._0._0),model));
              }
         default: var _p1 = A2($TagSelector.update,_p0._0,model.tagSelector);
           var tagSelector = _p1._0;
           var fx = _p1._1;
           var model$ = _U.update(model,{tagSelector: tagSelector});
           return {ctor: "_Tuple2",_0: model$,_1: $Effects.batch(_U.list([A2($Effects.map,TagSelectorAction,fx),getDocuments(model$)]))};}
   });
   var InputChange = function (a) {    return {ctor: "InputChange",_0: a};};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      A2($Basics._op["++"],
      _U.list([A2($Html.div,
              ...
              _U.list([$Html$Attributes.value(model.query)
                      ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p2) {    return A2($Signal.message,address,InputChange(_p2));})
                      ,$Html$Attributes.$class("u-full-width search-box")]),
              _U.list([]))]))
              ,A2($TagSelector.view,A2($Signal.forwardTo,address,TagSelectorAction),model.tagSelector)]),
      A2($List.map,$Database$Document.preview,model.documents)));
   });
   var Model = F3(function (a,b,c) {    return {query: a,documents: b,tagSelector: c};});
   var init = function () {
      var _p3 = $TagSelector.init;
      var tagSelector = _p3._0;
      var fx = _p3._1;
      var model = A3(Model,"",_U.list([]),tagSelector);
      return {ctor: "_Tuple2",_0: model,_1: $Effects.batch(_U.list([getDocuments(model),A2($Effects.map,TagSelectorAction,fx)]))};
   }();
...
Elm.Index.make = function (_elm) {
   ...
   "Index.InitalData",
   function (v) {
      return typeof v === "object" && "text" in v ? {_: {}
                                                    ,text: typeof v.text === "string" || typeof v.text === "object" && v.text instanceof String ? v.text : _U.badPort("a string",
                                                    v.text)} : _U.badPort("an object with fields `text`",v);
   });
   var SearchAction = function (a) {    return {ctor: "SearchAction",_0: a};};
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "ChangeInitialData") {
            return $EffectsUtil.noFx(_U.update(model,{initialData: _p0._0}));
         } else {
            return A3($EffectsUtil.update,function (x) {    return _U.update(model,{search: x});},SearchAction,A2($Search.update,_p0._0,model.search));
         }
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
   ...
   var InitalData = function (a) {    return {text: a};};
   var Model = F2(function (a,b) {    return {initialData: a,search: b};});
   var init = A3($EffectsUtil.update,function (x) {    return A2(Model,InitalData("placehold"),x);},SearchAction,$Search.init);
   var init$ = function () {
      var update$ = F2(function (action,_p1) {
         var _p2 = _p1;
         var _p3 = A2(update,action,_p2._0);
         var model$ = _p3._0;
         var fx$ = _p3._1;
         return {ctor: "_Tuple2",_0: model$,_1: $Effects.batch(_U.list([_p2._1,fx$]))};
      });
      return A2($List.foldr,update$,init);
   }();
   var app = $CustomStartApp.start({init: init$,update: update,view: view,inputs: inputs});
   var main = app.html;
